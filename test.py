...
print('Please indicate specs you desire the most.')
print()
...
# Pricing Information
base_price = {"WDell": 20000, "WAsus": 19000, "WAcer": 20000, "WHP": 22000, "WLenovo": 23000,}
feature_price = {"Speed": 1000, "RAM": 2000, "Storage": 500, "Screensize": 3000}


for n_laptops in range(2):
  ...
  # Compute the price (incremental + final)
  ...
  new_laptop["Price"] = "INR" + str(new_price)  
