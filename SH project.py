...
def reorder(winners_info_list, sorting_key, sorting_order):
  tt = sorted(winners_info_list, key = lambda x: x[sorting_key], reverse=(sorting_order == "D"))
  #tt = sorted(winners_info_list, key = sort_fn, reverse=(sorting_order == "D"))
  return tt 
...
def analyze(tname, tdata, sorting_key = "Times Won", sorting_order = "D"):
  ...
  # Reorder the data basis the sorting options
...
wimbledon_winners, wimbledon_mto_winners = analyze('Wimbledon', wimbledon_data, "Times Won", "A")
frenchopen_winners, frenchopen_mto_winners = analyze('French Open', frenchopen_data, "Name", "D")
